...
class Outage {
  ...
  close() {
    let sql = `UPDATE OUTAGES SET outage_status = 'Closed' WHERE user_email = '${this.user_email}' and service_type = '${this.service_type}' and service_name = '${this.service_name}' and latitude = '${this.latitude}'and longitude = '${this.longitude}'`;
    return db.execute(sql);
  }
}
